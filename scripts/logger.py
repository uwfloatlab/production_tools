...
# Setup logging
ser.port = "/dev/ttyUSB0"    # Serial port
logging_period = 0.1 # seconds
no_of_records = 100  # how many records to record
output_filename = 'dmm_out.csv'
output_directory = "/app/aadu/projects/production_tools/scripts"
